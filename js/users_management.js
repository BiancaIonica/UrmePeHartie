import { getDatabase, ref, get, child, remove, update } from '../src/firebaseConfig.js';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadDataIntoTable(userType, data, userId) {
        const table = document.getElementById(userType === 'admin' ? 'adminsTable' : 'usersTable').getElementsByTagName('tbody')[0];
    ...
    form.onsubmit = function(event) {
        ...
        update(userRef, { role: newRole }).then(() => {
